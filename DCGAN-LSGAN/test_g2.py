...
from lsgan2nd import Generator

parser = argparse.ArgumentParser()
parser.add_argument('-load_path', default='./../G2_Model/DCGAN_LSGAN.pth', help='Checkpoint to load path from') # please change to your model's path
